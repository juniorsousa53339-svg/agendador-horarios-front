...
export class AgendamentoPublicoApi {
  listarServicos(): Observable<ServicoDto[]> {
    ...
    const mock: ServicoDto[] = [
      { id: 1, nome_servico: 'Corte Masculino', duracao_minutos: 40, valor: 45, descricao: 'Tesoura e máquina' },
      { id: 2, nome_servico: 'Barba Completa', duracao_minutos: 30, valor: 35, descricao: 'Modelagem + navalha' },
